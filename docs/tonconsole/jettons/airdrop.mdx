---
title: Jetton Airdrop
description: Technical and Commercial Terms (T&C Terms)
---
...
> **Note**: Only the account specified in the **Airdrop file** can claim Jettons.
...
> **Note**: Only Airdrop admin will be able to manage the distribution (such as completing the distribution and withdrawing the accumulated profit).
...
> **Note**: To deploy the Airdrop smart contracts, you will need to have sufficient TON balance in the connected wallet to cover blockchain deployment fees.

    No funds will be deducted from your Ton Console balance. All deployment costs are paid directly from the connected wallet.
...
> **Note**: Before starting distributions of new Jettons, be sure to conduct a test run with a small number of Recipients.
...
> **Note**: Keep in mind that blockchain fees may vary depending on the Jettons contracts and other factors (e.g. the presence of a deployed Jetton wallet for the Recipient).
...
> **Note**: Code examples for multiple programming languages are available. Please refer to the source code repository.

### Test Claim button

> **Note**: It is used for testing purposes and leads to a reference implementation of the application.
